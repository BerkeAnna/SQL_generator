...
class Mosogep:
    def termek(rekord, hanyszor, milyentermek,  energiaosztaly, kapacitas, sulyenergiafogyasztas, sulyvizfogyasztas):
        global sor2
        s = []
        masodik_adat = []
        harmadik_adat = []
        ...
        while rekord <= hanyszor:
            ...
            print("INSERT INTO " + milyentermek + " VALUES('" + str(rekord) + "', '" + masodik + "', '" + harmadik + "', " + negyedik + ", " + otodik + ");")
            rekord += 1
